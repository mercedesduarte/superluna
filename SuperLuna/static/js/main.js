class SuperLunaApp {
    ...
    initEventListeners() {
        ...
        if (menuToggle && mobileMenu) {
            menuToggle.addEventListener('click', () => {
                ...
                console.log('Menu movil toggled');
            });
        }
    ...
    navigateToSection(sectionId) {
        console.log(`Navegando a seccion: ${sectionId}`);
        ...
        if (targetSection) {
            ...
            console.log(`Seccion ${sectionId} activada`);
        } else {
            console.warn(`Seccion ${sectionId} no encontrada`);
        }
    }
    ...
    async loadInitialData() {
        try {
            ...
            console.log('Respuesta categorias:', categoriesData);
            
            if (categoriesData.success) {
                this.categories = categoriesData.categories;
                this.buildCategoryMap();
                console.log(`${this.categories.length} categorias cargadas`);
            }
    ...
    buildCategoryMap() {
        ...
        console.log('Mapa de categorias:', this.categoryMap);
    }
        ...
        return `
            <div class="product-card" data-product-id="${product.id}">
                <div class="product-badge-container">
                    ...
                    ${isLowStock ? '<span class="product-badge low-stock">Poco Stock</span>' : ''}
                </div>
...
window.debugApp = {
    showData: () => {
        ...
        console.log('Categorias:', superLunaApp.categories);
    },
